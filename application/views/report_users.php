...
function main()
{
	...
	$type = set_value('type');
	$sql = 'SELECT id, type, name, mobile, email, created_at FROM users 
		where 1=1 ';
		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">REPORT USERS</li>
				</ul><!-- /.breadcrumb -->
				...
				<div class="col-xs-12">
					...
					<div class="widget-body">
						<div class="widget-main">
							...
							<form name="form_expense" class="form-horizontal" action="<?php echo base_url('main/users/search'); ?>" method="post" enctype="multipart/form-data" >
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">User Roles  <span class="text-danger">*</span></label>
										<?php $CI->RolesType_Search(set_value('type')); ?>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
					...
					<div style="overflow-x: scroll">
						<div class="row">
							...
							<div>
								<?php
								if($res){
									echo '<div class="center "><a class="btn btn-md btn-success" href="'.base_url().'main/users/export_csv/">Export CSV</a><br><br></div>';
								}
								?>
									...
									if($res){
										foreach ($res as $row) {
											...
											<tr>
												...
												<td>
													<a href="<?php echo base_url('main/users/info/'.$row['id']); ?>"><?php echo $row['id']; ?></a>
												</td>
