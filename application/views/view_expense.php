...
<?php
	$CI = get_instance();
	$expense = $CI->db->get_where('expenses', array('id' => $CI->session->flashdata('id')))->result_array();
?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">EXPENSE INFO</li>
						</ul><!-- /.breadcrumb -->
											...
											<?php
													...
													<div class="widget-box ui-sortable-handle">
														<div class="widget-header widget-header-small">
															<h4><i class="fa fa-television"></i> Viewing Expense Detail</h4>
														</div>
															...
															<div class="row">
																<div class="col-lg-6 col-sm-12 col-xs-12">
																	<div class="profile-user-info-striped">
																		...
																		<div class="profile-info-row">
																			<div class="profile-info-name"> Spent For</div>
																			<div class="profile-info-value">
																				<span class="" id="spent" style="display: inline;"><?php echo $row['spent']; ?></span>
																			</div>
																		</div>
																		<div class="profile-info-row">
																		...
																		<div class="profile-info-row">
																			<a class="tooltip-error btn btn-primary" data-rel="tooltip" title="Edit" href="<?php echo base_url('main/expense/edit/'.$row['id']); ?>">UPDATE EXPENSE
																				<span class="green">
