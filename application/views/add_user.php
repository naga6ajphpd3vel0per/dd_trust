							...
							<form class="form-horizontal" action="<?php echo base_url('main/users/add'); ?>" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<?php if ($admin_login == 'yes') { ?>
											...
											<?php $CI->RolesType(set_value('type')); ?>
										<?php } ?>
									...
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('username'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('password'); ?></div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
									...
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('dob'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">Gender <span class="text-danger">*</span></label>
										<?php $CI->Genders(set_value('gender')); ?>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('father_name'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('mother_name'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">Category <span class="text-danger">*</span></label>
										<?php $CI->Category(set_value('category')); ?>
									</div>
								</div>
								<div class="space space-8"></div>
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('identification'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('number'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">Mobile No<span class="text-danger">*</span></label>
										<input class="form-control input-sm" id="" type="text" name="mobile" placeholder="" value="<?php echo set_value('mobile'); ?>" />
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('mobile'); ?></div>
									</div>
								</div>
								<div class="space space-8"></div>
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<?php $CI->BloodGroup(set_value('blood_group')); ?>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">Educational Details <span class="text-danger">*</span></label>
										<?php $CI->EducationDetail(set_value('education')); ?>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">Marital Status <span class="text-danger">*</span></label>
										<?php $CI->MaritalStatus(set_value('marital_status')); ?>
									</div>
								</div>
								<div class="space space-8"></div>
								<div class="row">
									...
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<?php $CI->RelationStatus(set_value('relationship')); ?>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
								...
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('address'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('district'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('state'); ?></div>
									</div>
								</div>
								<div class="space space-8"></div>
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('pincode'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('village'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('city'); ?></div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('paddress'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">District <span class="text-danger">*</span></label>
										<input class="form-control input-sm number" id="" type="text" name="pdistrict" placeholder="" value="<?php echo set_value('pdistrict'); ?>" />
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('pdistrict'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">State <span class="text-danger">*</span></label>
										<input class="form-control input-sm number" id="" type="text" name="pstate" placeholder="" value="<?php echo set_value('pstate'); ?>" />
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('pstate'); ?></div>
									</div>
								</div>
								<div class="space space-8"></div>
								<div class="row">
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('ppincode'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">Village/Block <span class="text-danger">*</span></label>
										<input class="form-control input-sm email" id="" type="text" name="parea" placeholder="" value="<?php echo set_value('parea'); ?>" />
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('parea'); ?></div>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">City/Sub District/Tehsil <span class="text-danger">*</span></label>
										<input class="form-control input-sm email" id="" type="text" name="pcity" placeholder="" value="<?php echo set_value('pcity'); ?>" />
										<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('pcity'); ?></div>
									</div>
								</div>
								<div class="space space-8"></div>
								<div class="row">
									...
									<div class="col-lg-4 col-md-6 col-xs-12">
										...
										<?php $CI->AddressProof(set_value('address_proof')); ?>
									</div>
									<div class="col-lg-4 col-md-6 col-xs-12">
										<label for="">Contact No</label>
								...
								<div id="disab">
									...
									<div class="row">
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('dis_certificate'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('reg_no'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('doi'); ?></div>
										</div>
									</div>
									<div class="space space-8"></div>
									<div class="row">
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('percentage'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('since'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('scheme'); ?></div>
										</div>
									</div>
									<div class="space space-8"></div>
									<div class="row">
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('dis_type'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('by_birth'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('authority'); ?></div>
										</div>
									</div>
									<div class="space space-8"></div>
									<div class="row">
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('pension_no'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('hospital_treating'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('dis_email'); ?></div>
										</div>
									</div>
									<div class="space space-8"></div>
									<div class="row">
										<div class="col-lg-4 col-md-6 col-xs-12" id="empspec">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('dis_area'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('due_to'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											<label for="">Contact No</label>
								...
								<div id="emp">
									...
									<div class="row">
										<div class="col-lg-4 col-md-6 col-xs-12" id="empspec">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('emp'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('occupation'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
								...
								<div id="identity">
									...
									<div class="row">
										<div class="col-lg-4 col-md-6 col-xs-12" id="empspec">
											...
											<div style="color:red;font-size:15px;font-weight: bold;"><?php echo form_error('id_proof'); ?></div>
										</div>
										<div class="col-lg-4 col-md-6 col-xs-12">
