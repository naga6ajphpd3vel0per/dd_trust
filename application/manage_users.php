													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="<?php echo base_url('main/users/delete/'.$row['id']); ?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo base_url('main/users/delete/'.$row['id']); ?>" class="tooltip-error" data-rel="tooltip" title="Delete" onclick="return confirm('Are you sure want to delete?');">
																				<span class="red">
